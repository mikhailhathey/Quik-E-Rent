...
public class PowerToolModel {
    ...
    public PowerToolModel(String brand, String powerToolName, Integer year) {
        this.brand = brand;
        this.powerToolName = powerToolName;
        this.year = year;
    }

    public PowerToolModel(Long id, String brand, String powerToolName, Integer year) {
        this.id = id;
        this.brand = brand;
        this.powerToolName = powerToolName;
        this.year = year;
